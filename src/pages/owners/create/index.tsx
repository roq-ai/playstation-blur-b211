...
function OwnerCreatePage() {
  ...
  const formik = useFormik<OwnerInterface>({
    initialValues: {
      ...
      blu_ray_id: (router.query.blu_ray_id as string) ?? null,
    },
      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <AsyncSelect<UserInterface>
            ...
            labelField={'email'}
          />
          <AsyncSelect<BluRayInterface>
            formik={formik}
            name={'blu_ray_id'}
            label={'Select Blu Ray'}
            placeholder={'Select Blu Ray'}
            fetcher={() => roqClient.blu_ray.findManyWithCount({})}
            labelField={'title'}
          />
