...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Playstation Bluray Collection`}</title>

        <meta
          name="description"
          content="Welcome to Playstation Bluray Collection - Your Ultimate Destination for Rare Playstation BluRay Titles, Delivered Right to Your Digital Doorstep"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1607853202273-797f1c22a38e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxQbGF5c3RhdGlvbnxlbnwwfHx8fDE3MDAwMzg2MTN8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@martinkatler?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Martin Katler`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Playstation Bluray Collection`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Playstation Bluray Collection - Your Ultimate Destination for Rare Playstation BluRay Titles, Delivered Right to Your Digital Doorstep`}
            </Text>
            <Box
